...
import com.springboot.jpa.repository.custom.CustomOrderRepository;
...
public class OrderServiceTest {
    ...
    void 상품주문() {
        ...
        //Then
        Order getOrder = orderRepository.findById(orderId).orElse(new Order());
    ...
    void custom_주문_검색() {
        ...
        customOrderRepository.search(orderSearch);
    }
